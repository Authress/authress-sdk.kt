...
class UserPermissionsApi(basePath: kotlin.String = "/") : ApiClient(basePath) {
    ...
    fun getUserPermissionsForResource(userId: kotlin.String, resourceUri: kotlin.String): PermissionResponse {
        ...
        val response = request<PermissionResponse>(
                localVariableConfig
        )
    ...
    fun getUserResources(userId: kotlin.String, resourceUri: kotlin.String? = null, permissions: PermissionObjectSlashpropertiesSlashaction? = null, limit: kotlin.Int? = null, cursor: kotlin.String? = null): UserResources {
        ...
        val response = request<UserResources>(
                localVariableConfig
        )
    ...
    fun getUserRolesForResource(userId: kotlin.String, resourceUri: kotlin.String): UserRoleCollection {
        ...
        val response = request<UserRoleCollection>(
                localVariableConfig
        )
